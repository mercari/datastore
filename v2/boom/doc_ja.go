...
Cloud Datastoreの仕様を踏襲している go.mercari.io/datastore/v2 では、バックエンドがAppEngine Datastoreであってもこれと同様の振る舞いをします。
よって、Putした後、Commitより前にIDを使う必要があれば、事前に自分でAllocateIDをしておく必要があります。

また、boomはキャッシュ周りの仕組みを何も持っていません。
それは、 go.mercari.io/datastore/v2 が持つミドルウェアで行うべきものだからです。
シンプルでいいでしょ？
*/
