...
Please see https://godoc.org/go.mercari.io/datastore/v2/clouddatastore or https://godoc.org/go.mercari.io/datastore/v2/aedatastore .
...
If you are worried, you may have a clue to the solution at https://godoc.org/go.mercari.io/datastore/v2/clouddatastore .
...
Please refer to https://godoc.org/go.mercari.io/datastore/v2/dsmiddleware if you want to know the middleware already provided.
...
Batch() is it!
You can find the example at https://godoc.org/go.mercari.io/datastore/v2/#pkg-examples .


Boom replacing goon

I love goon.
So I made https://godoc.org/go.mercari.io/datastore/v2/boom which can be used in conjunction with this package.
...
from AE Datastore
	...
	import go.mercari.io/datastore/v2 and go.mercari.io/datastore/v2/aedatastore both.
	...
	If using google.golang.org/appengine/v2/datastore , replace to go.mercari.io/datastore/v2 .

from Cloud Datastore

	import go.mercari.io/datastore/v2 and go.mercari.io/datastore/v2/clouddatastore .
	rewrite those using functions of datastore package to FromContext function and Client method calls.
	replace *datastore.Commit to datastore.Commit .
	If using cloud.google.com/go/datastore , replace to go.mercari.io/datastore/v2 .
...
*/
package datastore // import "go.mercari.io/datastore/v2"
